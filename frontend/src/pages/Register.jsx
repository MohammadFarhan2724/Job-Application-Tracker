    ...
    <div className="min-h-screen flex bg-[#0A0F1C]">
      ...
      <div className="w-full lg:w-7/12 flex items-center justify-center px-6 py-12 bg-[#F5F6F8]">
        <div className="w-full max-w-sm animate-rise">
          ...
          <h2 className="font-display text-[#0A0F1C] text-3xl mb-2">Create your account.</h2>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              <label className="block text-xs font-mono uppercase tracking-widest text-[#0A0F1C] mb-1.5">Username</label>
              <input
                type="text"
                placeholder="johndoe"
                value={username}
          ...
          <p className="text-sm text-[#6B7280] mt-8 text-center">
            ...
            <Link to="/login" className="text-[#0A0F1C] font-semibold hover:text-[#22C58B] transition">
              Log in
            </Link>
          </p>
        </div>
